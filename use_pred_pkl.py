...
def plot_map(lats, lngs, mean_locations, median_locations, density_locations, ransac_locations, particle_locations, gmm_locations, particle_mahalanobis_locations, equinox_day_locations, equinox_declin_locations, mode='sun'):
    ...
    for place in lats:
        ...
        if not os.path.isdir('/srv/glusterfs/vli/maps8/' + mode + '/'):
            os.mkdir('/srv/glusterfs/vli/maps8/' + mode + '/')

        plt.savefig('/srv/glusterfs/vli/maps8/' + mode + '/' + place + '.png')
        plt.close()
...
def scatter(days_used, distances, fmt, label, color=None, linestyle=None, marker=None, cbm=False):
    ...
    plt.savefig('/srv/glusterfs/vli/maps8/' + prefix + label + '_days_used.png')
    plt.close()
...
def bar(x, y, ylabel, xlabel, x_labels, title, filename, yerr=None, ymax=None):
    ...
    plt.title(title)
    plt.savefig('/srv/glusterfs/vli/maps8/' + filename)
    plt.close()
