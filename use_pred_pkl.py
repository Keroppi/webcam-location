...
plt.xlabel('Error (min)')
plt.title('# of Days vs. Sunrise and Sunset Error (min)')
plt.savefig('/srv/glusterfs/vli/maps1/sunrise_sunset_err_outliers.png', dpi=100)
plt.close()
...
plt.savefig('/srv/glusterfs/vli/maps1/sunrise_signed_err.png', dpi=100)
plt.close()
...
plt.savefig('/srv/glusterfs/vli/maps1/sunset_signed_err.png', dpi=100)
plt.close()
